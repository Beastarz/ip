...
public class ClareCommands {
    private final static String DIVIDER = "----------------------------------------";
    private final static String DATA_PATH = "data/data.txt";
    ...
    /**
     * prints out the welcome message and load data
     */
    public static void welcome() {
        String welcomeText = "Hello dear, I am Clare!\nSo happy to see you today.\nWhat can I help?";
        try {
            Data.readFile(TASKS, DATA_PATH);
    ...
    private static void createTodo(String msg) {
        ...
        try {
            Data.addData(newTask, DATA_PATH);
        } catch (IOException e) {
    ...
    private static void mark(String num) {
        ...
        if (i < 0 || i >= TASKS.size()) {
            ...
            t.markDone();
            try {
                Data.rewriteData(TASKS, DATA_PATH);
            } catch (IOException e) {
                clareSays("Something went wrong. " + e);
            }
            System.out.println(DIVIDER);
